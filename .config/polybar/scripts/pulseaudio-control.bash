...
MUTED_COLOR="%{F#8C8C8C}"  # Color when the audio is muted
...
SINK_NICKNAMES["bluez_sink.CC_98_8B_31_4A_C0.a2dp_sink"]=""
# 
...
function output() {
    ...
    if [ "$isMuted" = "yes" ]; then
        ...
        local red_color="%{F#EC407A}"
        echo "${red_color}${volIcon}${END_COLOR}${curVol}% ${SINK_ICON}${nickname}"
    fi
}
