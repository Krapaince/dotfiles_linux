...
hi incsearch guibg=#613214
hi Pmenu guibg=#222222
hi errormsg guifg=red guibg=none ctermfg=red ctermbg=none
hi error cterm=undercurl ctermfg=red ctermbg=none gui=undercurl guifg=red guibg=none guisp=red
hi todo ctermbg=yellow ctermfg=black guibg=yellow guifg=black
hi folded cterm=underline ctermfg=238 ctermbg=242 guifg=Black guibg=DarkGrey
...
call <sid>hi('PmenuSel', s:cdPopupBack, s:cdPopupFront, 'none', {})
